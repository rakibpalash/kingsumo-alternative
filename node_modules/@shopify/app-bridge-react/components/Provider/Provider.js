...
function Provider(_a) {
     ...
     */
    var app = (0, react_1.useMemo)(function () { return (0, app_bridge_1.default)(config); }, []);
...
function Router(_a) {
    ...
    (0, ClientRouter_1.useClientRouting)(router.history);
    (0, RoutePropagator_1.useRoutePropagation)(router.location);
