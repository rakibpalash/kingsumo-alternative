...
function NavigationMenu(_a) {
    ...
    var location = (0, react_1.useMemo)(function () { return locationOrHref !== null && locationOrHref !== void 0 ? locationOrHref : window.location; }, [locationOrHref]);
    (0, react_1.useEffect)(function () {
        var items = navigationLinks.map(function (link) { return (0, AppLink_1.create)(app, link); });
        setItems(items);
    ...
    (0, react_1.useEffect)(function () {
         ...
         */
        (0, NavigationMenu_1.create)(app, { items: items, active: activeLink });
