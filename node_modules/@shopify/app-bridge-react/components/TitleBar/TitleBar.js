...
function updateSecondaryActions(titleBar, secondaryActions) {
    var _a, _b;
    var secondaryButtons = ((_b = (_a = titleBar.options.buttons) === null || _a === void 0 ? void 0 : _a.secondary) === null || _b === void 0 ? void 0 : _b.filter(function (button) { return !(0, ButtonGroup_1.isGroupedButton)(button); })) || [];
...
function updateButton(actionProps, button) {
    ...
    var redirect = (0, transformers_1.generateRedirect)(button.app, actionProps.url, actionProps.target, actionProps.external);
    if (redirect) {
